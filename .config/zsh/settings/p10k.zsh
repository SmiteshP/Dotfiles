# Generated by Powerlevel10k configuration wizard on 2020-09-16 at 20:43 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last 			### MYCHANGE
  typeset -g POWERLEVEL9K_DIR_PATH_HIGHLIGHT_BOLD=true					### MYCHANGE
